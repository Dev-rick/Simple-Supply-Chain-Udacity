...
contract SupplyChain is FarmerRole, DistributorRole, RetailerRole, ConsumerRole {
 ...
 // Define enum 'State' with the following values:
  ...
  struct Item {
    ...
    string imageHash; // Hash of the image stored at ipfs
  ...
  modifier harvested(uint _upc) {
    ...
    "Item has not been harvested yet or has already been processed");
    _;
  }
  ...
  modifier processed(uint _upc) {
    ...
    "Item has not been processed yet or has already been packed");
    _;
  }
  ...
  modifier packed(uint _upc) {
    ...
    "Item has not been packed yet or has already been up for sale");
    _;
  }
  ...
  modifier sold(uint _upc) {
    ...
    "Item has not been sold yet or has already been shipped");
    _;
  }
  ...
  modifier shipped(uint _upc) {
    ...
    "Item has not been shipped yet or has already been received");
    _;
  }
  ...
  modifier received(uint _upc) {
    ...
    "Item has not been received yet or has already been purchased");
    _;
  }
  ...
  // Define a method to get the imageHash
  function getImageHash(uint _upc) public view returns
    (
    ...
    )
  {
   return
   (
     imageHash = items[_upc].imageHash
   );
  }

  ///@dev had to split up in more buffers as 7 is the stack limit!!!
